...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/QBCategories/QBCategories.framework"
  install_framework "$BUILT_PRODUCTS_DIR/QBNavBarCustom/QBNavBarCustom.framework"
  install_framework "$BUILT_PRODUCTS_DIR/QBNetworking/QBNetworking.framework"
  install_framework "$BUILT_PRODUCTS_DIR/QBRefresh/QBRefresh.framework"
